...
@aura_agent.tool
async def read_project_memory(ctx: RunContext[AuraDeps]) -> str:
    """
...
@aura_agent.tool
async def get_memory_stats(ctx: RunContext[AuraDeps]) -> str:
    """
...
**MEMORY.md:**
- Lines: {stats.memory_md_lines} / {MEMORY_MAX_LINES if 'MEMORY_MAX_LINES' in dir() else 200} max
